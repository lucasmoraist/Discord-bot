//  Código pego do próprio site discordjs
//  Na guia de creating the main file
...
const commandsPath = path.join(__dirname,"commands"/*nome da pasta que irá entrar*/)
const commandFiles = fs.readdirSync(commandsPath).filter(file => file.endsWith(".js"))//filtro para que pegue apenas os arquivos que terminem com .js

//  Criar uma nova instância de cliente
const client = new Client({ intents: [GatewayIntentBits.Guilds] })
client.commands = new Collection()

//Para trazer a informação de cada um dos arquivos
